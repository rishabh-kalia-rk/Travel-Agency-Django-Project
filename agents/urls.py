...
from .views import AgentListView, AgentCreateView,AgentDetailView,AgentUpdateView,AgentDeleteView,AgentHistoryView
...
urlpatterns=[
    ...
    path('<int:pk>/history',AgentHistoryView.as_view(), name='agent-history'),
    ]
